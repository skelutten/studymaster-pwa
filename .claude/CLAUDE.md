...
- **🔒 Security Guidelines**: [`security.md`](security.md) - Security protocols and best practices
- **📍 Current Context**: [`context.md`](context.md) - Current project state and active development focus
